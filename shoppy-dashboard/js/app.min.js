...
!function(){"use strict";function t(t){return{getAllCountries:function(){return t.all("country").customGET().then(function(t){return t},function(t){return t.data})}}}angular.module("starter").factory("commonFctry",t),t.$inject=["Restangular"]}();
!function(){"use strict";function e(e,o,t,r,n,c){e.currentUser={},r.getUser()?(e.currentUser=r.getUser().user,console.log("$scope.currentUser: ",e.currentUser)):c.path("/login"),e.logout=function(){console.log("logout"),r.logout().then(function(e){e.success&&(n.remove("user"),n.remove("authdata"),c.path("/login"))})}}angular.module("starter").controller("mainCtrl",e),e.$inject=["$scope","$rootScope","$state","auth","localStorageService","$location"]}();
...
!function(){"use strict";function t(t){t.state("forgot_password",{url:"/forgot_password",templateUrl:"modules/forgot_password/forgot_password.html",data:{pageTitle:"Forgot Password",specialClass:"gray-bg"}})}function o(t){return{forgotPassword:function(o){return t.all("forgotpassword").customPOST(o).then(function(t){return t},function(t){return t.data})}}}angular.module("starter").config(t).factory("forgotFctry",o),t.$inject=["$stateProvider"],o.$inject=["Restangular"]}();
...
!function(){"use strict";function e(e,s,c,t,r,n){e.category={},e.withImage=!1,t&&c.getCategoryById(t).then(function(s){if(s&&s.success){var c=s.result;_.isEmpty(c)||(e.category=c)}}),e.upload=function(s){s?e.withImage=!0:e.withImage=!1},e.save=function(){t?c.updateCategoryById(t,e.category).then(function(e){e&&e.success?(r.success(e.msg,"Success"),n(function(){s.close("save")},300)):!e.success&&_.isArray(e.result)?_.each(e.result,function(e){r.warning(e.msg,"Warning")}):r.error(e.msg,"Error")}):c.saveCategories(e.category).then(function(e){e&&e.success?(r.success(e.msg,"Success"),n(function(){s.close("save")},300)):!e.success&&_.isArray(e.result)?_.each(e.result,function(e){r.warning(e.msg,"Warning")}):r.error(e.msg,"Error")})},e.removethumb=function(){e.category.c_file=null,e.withImage=!1},e.cancel=function(){s.dismiss("cancel")}}angular.module("starter").controller("categoryModalCtrl",e),e.$inject=["$scope","$uibModalInstance","categoryFctry","categoryId","toastr","$timeout"]}();
...
!function(){"use strict";function e(e,t,s,c,r,a,o,u){e.subcategory={},e.category={},e.withImage=!1,t.categoryId&&(r.getCategoryById(t.categoryId).then(function(t){if(t&&t.success){var s=t.result;_.isEmpty(s)||(e.category=s)}}),a&&c.getSubCategoryById(t.categoryId,a).then(function(t){if(t&&t.success){var s=t.result;_.isEmpty(s)||(e.subcategory=s)}})),e.upload=function(t){t?e.withImage=!0:e.withImage=!1},e.save=function(){e.subcategory.categoryId=e.category.categoryId,a?c.updateSubCategoryById(t.categoryId,a,e.subcategory).then(function(e){e&&e.success?(o.success(e.msg,"Success"),u(function(){s.close("save")},300)):!e.success&&_.isArray(e.result)?_.each(e.result,function(e){o.warning(e.msg,"Warning")}):o.error(e.msg,"Error")}):c.saveSubCategories(t.categoryId,e.subcategory).then(function(e){e&&e.success?(o.success(e.msg,"Success"),u(function(){s.close("save")},300)):!e.success&&_.isArray(e.result)?_.each(e.result,function(e){o.warning(e.msg,"Warning")}):o.error(e.msg,"Error")})},e.removethumb=function(){e.category.c_file=null,e.withImage=!1},e.cancel=function(){s.dismiss("cancel")}}angular.module("starter").controller("subCategoryModalCtrl",e),e.$inject=["$scope","$stateParams","$uibModalInstance","subCategoryFctry","categoryFctry","subCategoryId","toastr","$timeout"]}();
!function(){"use strict";function n(n,t){n.state("app.brands",{url:"/brands",templateUrl:"modules/brands/brands.html",data:{pageTitle:"Brands"},controller:"brandsCtrl"})}function t(n){return{getAllBrands:function(){return n.all("brand").customGET().then(function(n){return n},function(n){return n.data})},saveBrands:function(t){var r=new FormData;return r.append("b_file",t.b_file),r.append("name",t.name),n.all("brand").withHttpConfig({transformRequest:angular.identity}).customPOST(r,"",void 0,{"Content-Type":void 0}).then(function(n){return n},function(n){return n.data})},getBrandById:function(t){return n.all("brand").customGET(t).then(function(n){return n},function(n){return n.data})},updateBrandById:function(t,r){var a=new FormData;return a.append("b_file",r.b_file),a.append("name",r.name),n.all("brand/"+t).withHttpConfig({transformRequest:angular.identity}).customPUT(a,"",void 0,{"Content-Type":void 0}).then(function(n){return n},function(n){return n.data})},deleteBrandById:function(t){return n.all("brand").customDELETE(t).then(function(n){return n},function(n){return n.data})}}}angular.module("starter").config(n).factory("brandFctory",t),n.$inject=["$stateProvider","isPRODUCTION"],t.$inject=["Restangular"]}();
...
!function(){"use strict";function n(n,s,r,e,c,t){n.brand={},n.withImage=!1,e&&r.getBrandById(e).then(function(s){if(s&&s.success){var r=s.result;_.isEmpty(r)||(n.brand=r)}}),n.upload=function(s){s?n.withImage=!0:n.withImage=!1},n.save=function(){e?r.updateBrandById(e,n.brand).then(function(n){n&&n.success?(c.success(n.msg,"Success"),t(function(){s.close("save")},300)):!n.success&&_.isArray(n.result)?_.each(n.result,function(n){c.warning(n.msg,"Warning")}):c.error(n.msg,"Error")}):r.saveBrands(n.brand).then(function(n){n&&n.success?(c.success(n.msg,"Success"),t(function(){s.close("save")},300)):!n.success&&_.isArray(n.result)?_.each(n.result,function(n){c.warning(n.msg,"Warning")}):c.error(n.msg,"Error")})},n.removethumb=function(){n.brand.b_file=null,n.withImage=!1},n.cancel=function(){s.dismiss("cancel")}}angular.module("starter").controller("brandsModalCtrl",n),n.$inject=["$scope","$uibModalInstance","brandFctory","brandId","toastr","$timeout"]}();
!function(){"use strict";function n(n,t){n.state("app.banks",{url:"/banks",templateUrl:"modules/banks/banks.html",data:{pageTitle:"Banks"},controller:"banksCtrl"})}function t(n){return{getAllBanks:function(){return n.all("banks").customGET().then(function(n){return n},function(n){return n.data})},createBank:function(t){return n.all("banks").customPOST(t).then(function(n){return n},function(n){return n.data})},getBankById:function(t){return n.all("banks").customGET(t).then(function(n){return n},function(n){return n.data})},deleteBankById:function(t){return n.all("banks").customDELETE(t).then(function(n){return n},function(n){return n.data})},updateBankById:function(t,a){return n.all("banks/"+t).customPUT(a).then(function(n){return n},function(n){return n.data})}}}angular.module("starter").config(n).factory("banksFctry",t),n.$inject=["$stateProvider","isPRODUCTION"],t.$inject=["Restangular"]}();
...
!function(){"use strict";function s(s,n,c,e,t,r,u){s.countries=[],s.bank={},c.getAllCountries().then(function(n){n&&n.success&&(s.countries=n.result)}),t&&e.getBankById(t).then(function(n){if(n&&n.success){var c=n.result;_.isEmpty(c)||(s.bank=c)}}),s.save=function(){t?e.updateBankById(t,s.bank).then(function(s){s&&s.success?(r.success(s.msg,"Success"),u(function(){n.close("save")},300)):!s.success&&_.isArray(s.result)?_.each(s.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.msg,"Error")}):e.createBank(s.bank).then(function(s){s&&s.success?(r.success(s.msg,"Success"),u(function(){n.close("save")},300)):!s.success&&_.isArray(s.result)?_.each(s.result,function(s){r.warning(s.msg,"Warning")}):r.error(s.msg,"Error")})},s.cancel=function(){n.dismiss("cancel")}}angular.module("starter").controller("banksModalCtrl",s),s.$inject=["$scope","$uibModalInstance","commonFctry","banksFctry","bankId","toastr","$timeout"]}();
!function(){"use strict";function r(r,t){r.state("app.courier",{url:"/courier",templateUrl:"modules/courier/courier.html",data:{pageTitle:"Shipping Courier"},controller:"courierCtrl"})}function t(r){return{getAllCourier:function(){return r.all("courier").customGET().then(function(r){return r},function(r){return r.data})},createCourier:function(t){return r.all("courier").customPOST(t).then(function(r){return r},function(r){return r.data})},getCourierById:function(t){return r.all("courier").customGET(t).then(function(r){return r},function(r){return r.data})},deleteCourierById:function(t){return r.all("courier").customDELETE(t).then(function(r){return r},function(r){return r.data})},updateCourierById:function(t,n){return r.all("courier/"+t).customPUT(n).then(function(r){return r},function(r){return r.data})}}}angular.module("starter").config(r).factory("courierFctry",t),r.$inject=["$stateProvider","isPRODUCTION"],t.$inject=["Restangular"]}();
...
!function(){"use strict";function r(r,e,s,n,c,t){r.provider={},n&&s.getPaymentProviderById(n).then(function(e){if(e&&e.success){var s=e.result;_.isEmpty(s)||(r.provider=s)}}),r.save=function(){n?s.updatePaymentProviderById(n,r.provider).then(function(r){r&&r.success?(c.success(r.msg,"Success"),t(function(){e.close("save")},300)):!r.success&&_.isArray(r.result)?_.each(r.result,function(r){c.warning(r.msg,"Warning")}):c.error(r.msg,"Error")}):s.createPaymentProvider(r.provider).then(function(r){r&&r.success?(c.success(r.msg,"Success"),t(function(){e.close("save")},300)):!r.success&&_.isArray(r.result)?_.each(r.result,function(r){c.warning(r.msg,"Warning")}):c.error(r.msg,"Error")})},r.cancel=function(){e.dismiss("cancel")}}angular.module("starter").controller("paymentProviderModalCtrl",r),r.$inject=["$scope","$uibModalInstance","paymentProviderFctry","providerId","toastr","$timeout"]}();
!function(){"use strict";function e(e,l){e.state("app.sellers",{url:"/sellers",templateUrl:"modules/sellers/sellers.html",data:{pageTitle:"Sellers"},controller:"sellerCtrl"})}angular.module("starter").config(e),e.$inject=["$stateProvider","isPRODUCTION"]}();
!function(){"use strict";function e(e,l){e.addSeller=function(){var e=l.open({animation:!0,templateUrl:"modules/seller/seller.modal.html",controller:"sellerModalCtrl",size:"md"});e.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})}}angular.module("starter").controller("sellerCtrl",e),e.$inject=["$scope","$uibModal"]}();
...
!function(){"use strict";function e(e,r){e.state("app.buyers",{url:"/buyers",templateUrl:"modules/buyers/buyers.html",data:{pageTitle:"Buyers / Users"},controller:"buyerCtrl"})}angular.module("starter").config(e),e.$inject=["$stateProvider","isPRODUCTION"]}();
...
!function(){"use strict";function t(t,i){t.state("app.pushnotif",{url:"/pushnotifications",templateUrl:"modules/pushnotifications/pushnotif.html",data:{pageTitle:"Push Notification"}})}angular.module("starter").config(t),t.$inject=["$stateProvider","isPRODUCTION"]}();