...
!function(){"use strict";angular.module("starter").run(["$rootScope","$state","localStorageService","jwtHelper",function(e,r,o,t){if(console.log("run"),e.$state=r,e.$on("unauthorized",function(){o.remove("user"),o.remove("authdata"),r.go("login")}),o.get("user")){var n=o.get("user").token;t.isTokenExpired(n)&&(o.remove("user"),o.remove("authdata"),r.go("login"))}}]).filter("propsFilter",function(){return function(e,r){console.log("propsFilter");var o=[];if(angular.isArray(e)){var t=Object.keys(r);e.forEach(function(e){for(var n=!1,a=0;a<t.length;a++){var u=t[a],i=r[u].toLowerCase();if(e[u].toString().toLowerCase().indexOf(i)!==-1){n=!0;break}}n&&o.push(e)})}else o=e;return o}})}();
...
!function(){"use strict";function e(e,l,t,n,o,s,r,c){l.currentUser={},l.sellerInfo={},console.log("mainContCtrl"),o.getUser()?(l.currentUser=o.getUser().user,console.log("$scope.currentUser: ",l.currentUser)):r.path("/login"),e.parallel([function(e){c.getAllSellers().then(function(t){t&&t.success?l.sellerInfo.sellers=t.result.length||0:l.sellerInfo.sellers=0,e()})},function(e){c.getAllApplicants().then(function(t){t&&t.success?l.sellerInfo.applicants=t.result.length||0:l.sellerInfo.applicants=0,e()})}]),l.logout=function(){console.log("logout"),o.logout().then(function(e){e.success&&(s.remove("user"),s.remove("authdata"),r.path("/login"))})}}angular.module("starter").controller("mainContCtrl",e),e.$inject=["async","$scope","$rootScope","$state","auth","localStorageService","$location","sellersFctry"]}();
...
!function(){"use strict";function n(n){console.log("mobile.banners.config"),n.state("mobile.banners",{url:"/banners",templateUrl:"modules/mobiles/banners/banners.html",data:{pageTitle:"Mobile Banners"},controller:"mobileBannersCtrl"})}function e(n){return{getAllBanners:function(){return n.all("mobile/banner").customGET().then(function(n){return n},function(n){return n.data})},createMobileBanner:function(e){return n.all("mobile/banner").customPOST(e).then(function(n){return n},function(n){return n.data})},getMobileBanner:function(e){return n.all("mobile/banner").customGET(e).then(function(n){return n},function(n){return n.data})},deleteMobileBanner:function(e){return n.all("mobile/banner").customDELETE(e).then(function(n){return n},function(n){return n.data})},updateMobileBanner:function(e,t){return n.all("mobile/banner/"+e).customPUT(t).then(function(n){return n},function(n){return n.data})}}}angular.module("starter").config(n).factory("bannersFctry",e),n.$inject=["$stateProvider"],e.$inject=["Restangular"]}();
!function(){"use strict";function e(e,n,t,a,r,o,l,s){e.banners=[],e.dataSearch="",e.tableParams=new a({page:1,count:10},{getData:function(n){return s.getAllBanners().then(function(t){var a=t.result;return e.dataSearch?e.category=l("filter")(a,e.dataSearch):e.category=a,n.total(e.category.length),e.category.slice((n.page()-1)*n.count(),n.page()*n.count())})}}),e.refresh=function(){e.tableParams.reload()},e.addBanner=function(){var n=t.open({animation:!0,templateUrl:"modules/mobiles/banners/banners.modal.html",controller:"mobileBannersModalCtrl",size:"md",resolve:{bannerId:function(){return null}}});n.result.then(function(n){n&&e.refresh()},function(){})},e.updateBanner=function(n){var a=t.open({animation:!0,templateUrl:"modules/mobiles/banners/banners.modal.html",controller:"mobileBannersModalCtrl",size:"md",resolve:{bannerId:function(){return n.bannerId}}});a.result.then(function(n){n&&e.refresh()},function(){})},e.deleteSelected=function(n){console.log("item: ",n),r.openConfirm({templateUrl:"./modules/dialogs/delete.dialog.html",scope:e,className:"ngdialog-theme-default"}).then(function(){s.deleteMobileBanner(n.categoryId).then(function(n){n&&n.success&&(o.success(n.msg,"Success"),e.tableParams.reload())})},function(){})}}angular.module("starter").controller("mobileBannersCtrl",e),e.$inject=["$scope","$state","$uibModal","NgTableParams","ngDialog","toastr","$filter","bannersFctry"]}();
!function(){"use strict";function n(n,e,s,t,c,r,o,a){e.banner={},e.contents=[],e.withImage=!1,r&&t.getMobileBanner(r).then(function(s){if(s&&s.success){var t=s.result;n.isEmpty(t)||(e.category=t)}}),c.getAllMobileContents().then(function(s){if(s&&s.success){var t=s.result;n.isEmpty(t)||(e.contents=t),console.log("contents: ",e.contents)}}),e.upload=function(n){n?e.withImage=!0:e.withImage=!1},e.save=function(){r?t.updateMobileBanner(r,e.banner).then(function(e){e&&e.success?(o.success(e.msg,"Success"),a(function(){s.close("save")},300)):!e.success&&n.isArray(e.result)?n.each(e.result,function(n){o.warning(n.msg,"Warning")}):o.error(e.msg,"Error")}):t.createMobileBanner(e.banner).then(function(e){e&&e.success?(o.success(e.msg,"Success"),a(function(){s.close("save")},300)):!e.success&&n.isArray(e.result)?n.each(e.result,function(n){o.warning(n.msg,"Warning")}):o.error(e.msg,"Error")})},e.removethumb=function(){e.banner.c_file=null,e.withImage=!1},e.cancel=function(){s.dismiss("cancel")}}angular.module("starter").controller("mobileBannersModalCtrl",n),n.$inject=["_","$scope","$uibModalInstance","bannersFctry","contentsFctry","bannerId","toastr","$timeout"]}();
...
!function(){"use strict";function e(e){console.log("sellers.config"),e.state("app.sellers",{url:"/sellers",templateUrl:"modules/sellers/sellers.html",data:{pageTitle:"Sellers"},controller:"sellerCtrl"})}function l(e){return{getAllSellers:function(){return e.all("seller").customGET().then(function(e){return e},function(e){return e.data})},getAllApplicants:function(){return e.all("seller/applicants").customGET().then(function(e){return e},function(e){return e.data})}}}angular.module("starter").config(e).factory("sellersFctry",l),e.$inject=["$stateProvider"],l.$inject=["Restangular"]}();
!function(){"use strict";function e(e,l,t,a,r,s){console.log("sellerCtrl"),l.sellers=[],l.dataSearch="",l.radioModel="Sellers",l.tableParams=new r({page:1,count:10},{getData:function(t){return a.getAllSellers().then(function(a){if(a&&a.success){var r=a.result;return l.dataSearch?l.sellers=s("filter")(r,l.dataSearch):l.sellers=r,e.each(l.sellers,function(e){e.sellerApprovalDate=new Date(e.sellerApprovalDate)}),t.total(l.sellers.length),l.sellers.slice((t.page()-1)*t.count(),t.page()*t.count())}})}}),l.addSeller=function(){var e=t.open({animation:!0,templateUrl:"modules/seller/seller.modal.html",controller:"sellerModalCtrl",size:"md"});e.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})},l.refresh=function(){l.tableParams.reload()},l.showSellers=function(){l.tableParams=new r({page:1,count:10},{getData:function(t){return a.getAllSellers().then(function(a){if(a&&a.success){var r=a.result;return l.dataSearch?l.sellers=s("filter")(r,l.dataSearch):l.sellers=r,e.each(l.sellers,function(e){e.sellerApprovalDate=new Date(e.sellerApprovalDate)}),t.total(l.sellers.length),l.sellers.slice((t.page()-1)*t.count(),t.page()*t.count())}})}})},l.showApplicants=function(){l.tableParams=new r({page:1,count:10},{getData:function(t){return a.getAllApplicants().then(function(a){if(a&&a.success){var r=a.result;return l.dataSearch?l.sellers=s("filter")(r,l.dataSearch):l.sellers=r,e.each(l.sellers,function(e){e.sellerApplicationDate=new Date(e.sellerApplicationDate)}),t.total(l.sellers.length),l.sellers.slice((t.page()-1)*t.count(),t.page()*t.count())}})}})}}angular.module("starter").controller("sellerCtrl",e),e.$inject=["_","$scope","$uibModal","sellersFctry","NgTableParams","$filter"]}();
...
!function(){"use strict";function e(e){console.log("buyers.config"),e.state("app.buyers",{url:"/buyers",templateUrl:"modules/buyers/buyers.html",data:{pageTitle:"Buyers / Users"},controller:"buyerCtrl"})}angular.module("starter").config(e),e.$inject=["$stateProvider"]}();
!function(){"use strict";function e(e,l){e.addSeller=function(){var e=l.open({animation:!0,templateUrl:"modules/seller/seller.modal.html",controller:"buyerModalCtrl",size:"md"});e.result.then(function(){},function(){console.info("Modal dismissed at: "+new Date)})}}angular.module("starter").controller("buyerCtrl",e),e.$inject=["$scope","$uibModal"]}();
