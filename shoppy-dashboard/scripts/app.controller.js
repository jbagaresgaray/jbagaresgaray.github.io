(function() {
     ...
     */
    modalDemoCtrl.$inject = ['$scope', '$uibModal'];
    ...
    function GoogleMaps($scope) {
        $scope.mapOptions = {
            zoom: 11,
            center: new window.google.maps.LatLng(40.6700, -73.9400),
        ...
        $scope.mapOptions3 = {
            center: new window.google.maps.LatLng(36.964645, -122.01523),
            zoom: 18,
            // Style for Google Maps
    ...
    function formValidation($scope) {
        ...
        $scope.signupForm = function() {
            if ($scope.signup_form.$valid) {} else {
    ...
    function chartistCtrl() {
        ...
        this.pieOptions = {
            labelInterpolationFnc: function(value) {
                return Math.round(value / prepareData1.series.reduce(sum) * 100) + '%';
            }
        };
    ...
    toastrCtrl.$inject = ['$scope', '$timeout'];
    ...
    passwordMeterCtrl.$inject = ['$scope'];
